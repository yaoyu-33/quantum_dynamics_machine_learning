...
if __name__ == '__main__':
    ...
    for i in range(len(weights)):
        weights[i] = (abs(weights[i]) > 0.00001) * weights[i]
    ...
    for i in range(len(weights)):
        weights[i] = (abs(weights[i]) > 0.0001) * weights[i]
    ...
    for i in range(len(weights)):
        weights[i] = (abs(weights[i]) > 0.001) * weights[i]
    ...
    for i in range(len(weights)):
        weights[i] = (abs(weights[i]) > 0.01) * weights[i]
    ...
    results.to_csv('prune_full_results.csv')